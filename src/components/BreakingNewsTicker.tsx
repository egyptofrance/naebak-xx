...
export function BreakingNewsTicker({ newsItems, scrollSpeed = 50 }: BreakingNewsTickerProps) {
  ...
  return (
    <div className="breaking-news-container w-full">
      {/* Top green line */}
      <div className="h-[2px] lg:h-[2px] bg-green-600" />
      ...
      <div className="relative bg-gray-800 overflow-hidden">
        <div className="flex items-center h-6 lg:h-10">
          ...
          <div className="absolute right-0 top-0 bottom-0 z-10 flex items-center">
            <div className="relative bg-gradient-to-l from-green-600 to-green-700 px-2 h-full flex items-center shadow-xl">
              ...
              <div className="absolute -left-2 top-0 bottom-0 w-4 bg-gradient-to-r from-green-700 to-transparent transform -skew-x-12" />
            </div>
          </div>
      ...
      {/* Bottom green line */}
      <div className="h-[4px] lg:h-[4px] bg-green-600" />
